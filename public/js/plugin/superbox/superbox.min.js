        ...
        return this.each(function () {
            ...
            $('.superbox-list').click(function () {
                ...
                if (options.editClick) {
                    superboximg.find('a.btn-primary').click(function () {
                        options.editClick.call($this);
                    });
                }
                if (options.deleteClick) {
                    superboximg.find('a.btn-danger').click(function () {
                        options.deleteClick.call($this);
                    });
                }
                //console.log("fierd")
